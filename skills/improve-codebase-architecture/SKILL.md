...
- Contributing/architecture docs (if they exist in the project)
...
4. Hand off for execution:
   ...
   - If work spans subsystem boundaries, use `graphify` to map architecture and boundary impacts before coding.
