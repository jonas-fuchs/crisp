---
name: graphify
description: "Use for cross-module architecture, dependency paths, subsystem relationships, or broad repository analysis — especially when graphify-out/ exists, where the question should be treated as a graphify query first. Do not use for local single-file questions or routine edits. Turns any input (code, docs, papers, images, videos) into a persistent knowledge graph with god nodes, community detection, and query/path/explain tools."
